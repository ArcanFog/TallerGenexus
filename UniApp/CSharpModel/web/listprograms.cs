/*
       ...
       Generated on: 10/17/2020 2:50:39.62
...
namespace GeneXus.Programs {
   public class listprograms : GXProcedure
   {
      ...
      {
         this.AV9ProgramNames = new GXBaseCollection<SdtProgramNames_ProgramName>( context, "ProgramName", "UniApp") ;
         initialize();
         executePrivate();
      ...
      public void executeSubmit( out GXBaseCollection<SdtProgramNames_ProgramName> aP0_ProgramNames )
      {
         ...
         objlistprograms.AV9ProgramNames = new GXBaseCollection<SdtProgramNames_ProgramName>( context, "ProgramName", "UniApp") ;
      ...
      void executePrivate( )
      {
         ...
         AV9ProgramNames = new GXBaseCollection<SdtProgramNames_ProgramName>( context, "ProgramName", "UniApp");
         AV11name = "WWAsignatura";
         AV12description = "Asignaturas";
         AV13link = "wwasignatura.aspx";
         ...
         AV11name = "WWCarrera";
         AV12description = "Carreras";
         AV13link = "wwcarrera.aspx";
         /* Execute user subroutine: 'ADDPROGRAM' */
         S111 ();
         if ( returnInSub )
         {
         ...
         AV11name = "WWCertificado";
         AV12description = "Certificadoes";
         AV13link = "wwcertificado.aspx";
         /* Execute user subroutine: 'ADDPROGRAM' */
         S111 ();
         if ( returnInSub )
         {
         ...
         AV11name = "WWDocente";
         AV12description = "Docentes";
         AV13link = "wwdocente.aspx";
         /* Execute user subroutine: 'ADDPROGRAM' */
         S111 ();
         if ( returnInSub )
         {
         ...
         AV11name = "WWExamen";
         AV12description = "Examen";
         AV13link = "wwexamen.aspx";
         /* Execute user subroutine: 'ADDPROGRAM' */
         S111 ();
         if ( returnInSub )
         {

/*
               File: ViewCertificado
        Description: View Certificado
             Author: GeneXus C# Generator version 16_0_1-129648
       Generated on: 10/17/2020 2:46:28.77
...
namespace GeneXus.Programs {
   public class viewcertificado : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public viewcertificado( IGxContext context )
      {
      ...
      public void execute( short aP0_CertificadoId ,
                           String aP1_TabCode )
      {
         this.AV12CertificadoId = aP0_CertificadoId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12CertificadoId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12CertificadoId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12CertificadoId), 4, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vCERTIFICADOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12CertificadoId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202010172462881", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewcertificado.aspx") + "?" + UrlEncode("" +AV12CertificadoId) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode))+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens = "hsh" + "ViewCertificado";
         forbiddenHiddens = forbiddenHiddens + context.localUtil.Format(A28CertificadoFecha, "99/99/99");
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens, GXKey));
         GXUtil.WriteLog("viewcertificado:[SendSecurityCheck value for]"+"CertificadoFecha:"+context.localUtil.Format(A28CertificadoFecha, "99/99/99"));
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vCERTIFICADOID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12CertificadoId), 4, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vCERTIFICADOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12CertificadoId), "ZZZ9"), context));
      ...
      {
         return formatLink("viewcertificado.aspx") + "?" + UrlEncode("" +AV12CertificadoId) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode)) ;
      }

      public override String GetPgmname( )
      {
         return "ViewCertificado" ;
      }
      ...
      protected void WB0T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Certificado Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_ViewCertificado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Certificadoes", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, "HLP_ViewCertificado.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtCertificadoFecha_Internalname, context.localUtil.Format(A28CertificadoFecha, "99/99/99"), context.localUtil.Format( A28CertificadoFecha, "99/99/99"), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtCertificadoFecha_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtCertificadoFecha_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_ViewCertificado.htm");
            GxWebStd.gx_bitmap( context, edtCertificadoFecha_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtCertificadoFecha_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_ViewCertificado.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewCertificado.htm");
            /* Div Control */
      ...
      protected void START0T2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Certificado", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF0T2( )
      {
         ...
         {
            /* Using cursor H000T2 */
            pr_default.execute(0, new Object[] {AV12CertificadoId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A16CertificadoId = H000T2_A16CertificadoId[0];
               A28CertificadoFecha = H000T2_A28CertificadoFecha[0];
      ...
      protected void STRUP0T0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A28CertificadoFecha", context.localUtil.Format(A28CertificadoFecha, "99/99/99"));
            /* Read saved values. */
            AV12CertificadoId = (short)(context.localUtil.CToN( cgiGet( "vCERTIFICADOID"), ".", ","));
            ...
            {
               GXUtil.WriteLog("viewcertificado:[SecurityCheckFailed value for]"+"CertificadoFecha:"+context.localUtil.Format(A28CertificadoFecha, "99/99/99"));
               GxWebError = 1;
      ...
      protected void E110T2( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H000T3 */
         pr_default.execute(1, new Object[] {AV12CertificadoId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A16CertificadoId = H000T3_A16CertificadoId[0];
            A28CertificadoFecha = H000T3_A28CertificadoFecha[0];
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A28CertificadoFecha", context.localUtil.Format(A28CertificadoFecha, "99/99/99"));
            AV16GXLvl6 = 1;
            Form.Caption = context.localUtil.DToC( A28CertificadoFecha, 1, "/");
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwcertificado.aspx") ;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "CertificadoGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "certificadogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "CertificadoGeneral";
               WebComp_Generalwc_Component = "CertificadoGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0030",(String)"",(short)AV12CertificadoId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12CertificadoId = Convert.ToInt16(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12CertificadoId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12CertificadoId), 4, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vCERTIFICADOID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12CertificadoId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?202010172462923", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewcertificado.js", "?202010172462923", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12CertificadoId',fld:'vCERTIFICADOID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A28CertificadoFecha',fld:'CERTIFICADOFECHA',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000T2_A16CertificadoId = new short[1] ;
         H000T2_A28CertificadoFecha = new DateTime[] {DateTime.MinValue} ;
         hsh = "";
         H000T3_A16CertificadoId = new short[1] ;
         H000T3_A28CertificadoFecha = new DateTime[] {DateTime.MinValue} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewcertificado__default(),
            new Object[][] {
                new Object[] {
               H000T2_A16CertificadoId, H000T2_A28CertificadoFecha
               }
               , new Object[] {
               H000T3_A16CertificadoId, H000T3_A28CertificadoFecha
               }
            }
         );
      ...
      private short AV12CertificadoId ;
      private short wcpOAV12CertificadoId ;
      ...
      private short[] H000T2_A16CertificadoId ;
      private DateTime[] H000T2_A28CertificadoFecha ;
      private short[] H000T3_A16CertificadoId ;
      private DateTime[] H000T3_A28CertificadoFecha ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewcertificado__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV12CertificadoId",SqlDbType.SmallInt,4,0}
          } ;
          Object[] prmH000T3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H000T2", "SELECT [CertificadoId], [CertificadoFecha] FROM [Certificado] WITH (NOLOCK) WHERE [CertificadoId] = @AV12CertificadoId ORDER BY [CertificadoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000T2,1,0,true,true )
             ,new CursorDef("H000T3", "SELECT [CertificadoId], [CertificadoFecha] FROM [Certificado] WITH (NOLOCK) WHERE [CertificadoId] = @AV12CertificadoId ORDER BY [CertificadoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000T3,1,0,false,true )
          };
       }
    }

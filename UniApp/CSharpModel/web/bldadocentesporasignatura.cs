...
using System.IO;
public class bldadocentesporasignatura : GxBaseBuilder
{
   string cs_path = "." ;
   public bldadocentesporasignatura( ) : base()
   {
   }
   ...
   {
      bldadocentesporasignatura x = new bldadocentesporasignatura() ;
      x.SetMainSourceFile( "adocentesporasignatura.cs");

/*
       ...
       Generated on: 10/17/2020 11:15:54.94
...
namespace GeneXus.Programs {
   public class wwexamen : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwexamen( )
      {
      ...
      public wwexamen( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV13ExamenFecha = context.localUtil.ParseDateParm( GetNextPar( ));
               ...
               gxgrGrid_refresh( subGrid_Rows, AV13ExamenFecha, AV19Pgmname, AV14Update, AV15Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202010171115550", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwexamen.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vEXAMENFECHA", context.localUtil.Format(AV13ExamenFecha, "99/99/99"));
         /* Send saved values. */
      ...
      {
         return formatLink("wwexamen.aspx")  ;
      }
      ...
      protected void WB0X0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Examen", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_WWExamen.htm");
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWExamen.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavExamenfecha_Internalname, "Examen Fecha", "col-sm-3 DateFilterSearchAttributeLabel", 0, true);
            /* Single line edit */
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 16,'',false,'" + sGXsfl_25_idx + "',0)\"";
            context.WriteHtmlText( "<div id=\""+edtavExamenfecha_Internalname+"_dp_container\" class=\"dp_container\" style=\"white-space:nowrap;display:inline;\">") ;
            GxWebStd.gx_single_line_edit( context, edtavExamenfecha_Internalname, context.localUtil.Format(AV13ExamenFecha, "99/99/99"), context.localUtil.Format( AV13ExamenFecha, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'MDY',0,12,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,16);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavExamenfecha_Jsonclick, 0, "DateFilterSearchAttribute", "", "", "", "", 1, edtavExamenfecha_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_WWExamen.htm");
            GxWebStd.gx_bitmap( context, edtavExamenfecha_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtavExamenfecha_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_WWExamen.htm");
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Examenfecha Changed */
                                       if ( context.localUtil.CToT( cgiGet( "GXH_vEXAMENFECHA"), 0) != AV13ExamenFecha )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0X2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavExamenfecha_Internalname;
      ...
      protected void RF0X2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H000X2 */
            pr_default.execute(0, new Object[] {AV13ExamenFecha, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_25_idx), 4, 0)), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_Recordsperpage( ) ) ) ) )
            {
               A25ExamenCarrAsigAsignaturaNombre = H000X2_A25ExamenCarrAsigAsignaturaNombre[0];
               A24ExamenCarrAsigAsignaturaId = H000X2_A24ExamenCarrAsigAsignaturaId[0];
               A23ExamenCarrAsigCarreraNombre = H000X2_A23ExamenCarrAsigCarreraNombre[0];
               A22ExamenCarrAsigCarreraId = H000X2_A22ExamenCarrAsigCarreraId[0];
               A26ExamenFecha = H000X2_A26ExamenFecha[0];
               A17ExamenId = H000X2_A17ExamenId[0];
               A23ExamenCarrAsigCarreraNombre = H000X2_A23ExamenCarrAsigCarreraNombre[0];
               A25ExamenCarrAsigAsignaturaNombre = H000X2_A25ExamenCarrAsigAsignaturaNombre[0];
               E140X2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_EXAMENID"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A17ExamenId), "ZZZ9"), context));
      }
      ...
      protected int subGrid_Recordcount( )
      {
         ...
         /* Using cursor H000X3 */
         pr_default.execute(1, new Object[] {AV13ExamenFecha});
      ...
      protected void STRUP0X0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.VCDate( cgiGet( edtavExamenfecha_Internalname), 1) == 0 )
            {
               GX_msglist.addItem(context.GetMessage( "GXM_faildate", new   object[]  {"Examen Fecha"}), 1, "vEXAMENFECHA");
               GX_FocusControl = edtavExamenfecha_Internalname;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV13ExamenFecha = DateTime.MinValue;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13ExamenFecha", context.localUtil.Format(AV13ExamenFecha, "99/99/99"));
            }
            else
            {
               AV13ExamenFecha = context.localUtil.CToD( cgiGet( edtavExamenfecha_Internalname), 1);
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13ExamenFecha", context.localUtil.Format(AV13ExamenFecha, "99/99/99"));
            }
            /* Read saved values. */
            ...
            if ( context.localUtil.CToD( cgiGet( "GXH_vEXAMENFECHA"), 1) != AV13ExamenFecha )
            {
               GRID_nFirstRecordOnPage = 0;
            }
         }
      ...
      protected void S122( )
      {
         ...
         if ( StringUtil.StrCmp(AV7HTTPRequest.Method, "GET") == 0 )
         {
            ...
            {
               AV13ExamenFecha = context.localUtil.CToD( ((SdtGridState_FilterValue)AV8GridState.gxTpr_Filtervalues.Item(1)).gxTpr_Value, 1);
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV13ExamenFecha", context.localUtil.Format(AV13ExamenFecha, "99/99/99"));
            }
      ...
      protected void S132( )
      {
         ...
         AV9GridStateFilterValue.gxTpr_Value = context.localUtil.DToC( AV13ExamenFecha, 1, "/");
      ...
      protected void S112( )
      {
         ...
         AV11TrnContext.gxTpr_Transactionname = "Examen";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2020101711155579", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwexamen.js", "?2020101711155579", false, true);
         }
      ...
      protected void init_default_properties( )
      {
         ...
         edtavExamenfecha_Internalname = "vEXAMENFECHA";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavExamenfecha_Jsonclick = "";
         edtavExamenfecha_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:''},{av:'AV13ExamenFecha',fld:'vEXAMENFECHA',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E140X2',iparms:[{av:'A17ExamenId',fld:'EXAMENID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E110X2',iparms:[{av:'A17ExamenId',fld:'EXAMENID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:''},{av:'AV13ExamenFecha',fld:'vEXAMENFECHA',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:''},{av:'AV13ExamenFecha',fld:'vEXAMENFECHA',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:''},{av:'AV13ExamenFecha',fld:'vEXAMENFECHA',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV14Update',fld:'vUPDATE',pic:''},{av:'AV15Delete',fld:'vDELETE',pic:''},{av:'AV19Pgmname',fld:'vPGMNAME',pic:''},{av:'AV13ExamenFecha',fld:'vEXAMENFECHA',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H000X2_A25ExamenCarrAsigAsignaturaNombre = new String[] {""} ;
         H000X2_A24ExamenCarrAsigAsignaturaId = new short[1] ;
         H000X2_A23ExamenCarrAsigCarreraNombre = new String[] {""} ;
         H000X2_A22ExamenCarrAsigCarreraId = new short[1] ;
         H000X2_A26ExamenFecha = new DateTime[] {DateTime.MinValue} ;
         H000X2_A17ExamenId = new short[1] ;
         ...
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwexamen__default(),
            new Object[][] {
                new Object[] {
               H000X2_A25ExamenCarrAsigAsignaturaNombre, H000X2_A24ExamenCarrAsigAsignaturaId, H000X2_A23ExamenCarrAsigCarreraNombre, H000X2_A22ExamenCarrAsigCarreraId, H000X2_A26ExamenFecha, H000X2_A17ExamenId
               }
               , new Object[] {
      ...
      private int edtavExamenfecha_Enabled ;
      ...
      private String edtavExamenfecha_Internalname ;
      private String edtavExamenfecha_Jsonclick ;
      ...
      private DateTime AV13ExamenFecha ;
      ...
      private String[] H000X2_A25ExamenCarrAsigAsignaturaNombre ;
      private short[] H000X2_A24ExamenCarrAsigAsignaturaId ;
      private String[] H000X2_A23ExamenCarrAsigCarreraNombre ;
      private short[] H000X2_A22ExamenCarrAsigCarreraId ;
      private DateTime[] H000X2_A26ExamenFecha ;
      private short[] H000X2_A17ExamenId ;
   ...
   public class wwexamen__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             DateTime A26ExamenFecha )
      {
         ...
         String sFromString ;
         String sOrderString ;
         sSelectString = " T3.[AsignaturaNombre] AS ExamenCarrAsigAsignaturaNombre, T1.[ExamenCarrAsigAsignaturaId] AS ExamenCarrAsigAsignaturaId, T2.[CarreraNombre] AS ExamenCarrAsigCarreraNombre, T1.[ExamenCarrAsigCarreraId] AS ExamenCarrAsigCarreraId, T1.[ExamenFecha], T1.[ExamenId]";
         sFromString = " FROM (([Examen] T1 WITH (NOLOCK) INNER JOIN [Carrera] T2 WITH (NOLOCK) ON T2.[CarreraId] = T1.[ExamenCarrAsigCarreraId]) INNER JOIN [CarreraAsignatura] T3 WITH (NOLOCK) ON T3.[CarreraId] = T1.[ExamenCarrAsigCarreraId] AND T3.[AsignaturaId] = T1.[ExamenCarrAsigAsignaturaId])";
         sOrderString = "";
         if ( ! (DateTime.MinValue==AV13ExamenFecha) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
               sWhereString = sWhereString + " and (T1.[ExamenFecha] >= @AV13ExamenFecha)";
            }
            else
            {
               sWhereString = sWhereString + " (T1.[ExamenFecha] >= @AV13ExamenFecha)";
            }
         }
         else
         {
         ...
         sOrderString = sOrderString + " ORDER BY T1.[ExamenFecha]";
                                             ...
                                             DateTime A26ExamenFecha )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM (([Examen] T1 WITH (NOLOCK) INNER JOIN [Carrera] T2 WITH (NOLOCK) ON T2.[CarreraId] = T1.[ExamenCarrAsigCarreraId]) INNER JOIN [CarreraAsignatura] T3 WITH (NOLOCK) ON T3.[CarreraId] = T1.[ExamenCarrAsigCarreraId] AND T3.[AsignaturaId] = T1.[ExamenCarrAsigAsignaturaId])";
         if ( ! (DateTime.MinValue==AV13ExamenFecha) )
         {
            if ( StringUtil.StrCmp("", sWhereString) != 0 )
            {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H000X2(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] );
               case 1 :
                     return conditional_H000X3(context, (DateTime)dynConstraints[0] , (DateTime)dynConstraints[1] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV13ExamenFecha",SqlDbType.DateTime,8,0} ,

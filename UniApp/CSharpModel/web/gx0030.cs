/*
       ...
       Generated on: 10/17/2020 10:48:49.86
...
namespace GeneXus.Programs {
   public class gx0030 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV10cAsignaturaSemestre = context.localUtil.ParseDateParm( GetNextPar( ));
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cAsignaturaId, AV7cAsignaturaNombre, AV10cAsignaturaSemestre) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2020101710484993", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0030.aspx") + "?" + UrlEncode("" +AV8pAsignaturaId)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vCASIGNATURASEMESTRE", context.localUtil.Format(AV10cAsignaturaSemestre, "99/99/99"));
         /* Send saved values. */
      ...
      {
         return formatLink("gx0030.aspx") + "?" + UrlEncode("" +AV8pAsignaturaId) ;
      }
      ...
      protected void WB100( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblasignaturaidfilter_Internalname, "Asignatura Id", "", "", lblLblasignaturaidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11101_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx0030.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblasignaturanombrefilter_Internalname, "Asignatura Nombre", "", "", lblLblasignaturanombrefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e12101_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx0030.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblasignaturasemestrefilter_Internalname, "Asignatura Semestre", "", "", lblLblasignaturasemestrefilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e13101_client"+"'", "", "WWAdvancedLabel WWDateFilterLabel", 7, "", 1, 1, 1, "HLP_Gx0030.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtavCasignaturasemestre_Internalname, context.localUtil.Format(AV10cAsignaturaSemestre, "99/99/99"), context.localUtil.Format( AV10cAsignaturaSemestre, "99/99/99"), TempTags+" onchange=\""+"gx.date.valid_date(this, 8,'MDY',0,12,'eng',false,0);"+";gx.evt.onchange(this, event)\" "+" onblur=\""+";gx.evt.onblur(this,36);\"", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtavCasignaturasemestre_Jsonclick, 0, "Attribute", "", "", "", "", 1, edtavCasignaturasemestre_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_Gx0030.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(44), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e14101_client"+"'", TempTags, "", 2, "HLP_Gx0030.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    if ( ! wbErr )
                                    {
                                       ...
                                       if ( context.localUtil.CToT( cgiGet( "GXH_vCASIGNATURASEMESTRE"), 0) != AV10cAsignaturaSemestre )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void gxgrGrid1_refresh( int subGrid1_Rows ,
                                        ...
                                        DateTime AV10cAsignaturaSemestre )
      {
         initialize_formulas( ) ;
         GxWebStd.set_html_headers( context, 0, "", "");
      ...
      protected void RF102( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 ...
                                                 AV10cAsignaturaSemestre ,
                                                 A11AsignaturaNombre ,
                                                 A21AsignaturaSemestre ,
                                                 AV6cAsignaturaId } ,
                                                 new int[]{
                                                 TypeConstants.STRING, TypeConstants.DATE, TypeConstants.STRING, TypeConstants.DATE, TypeConstants.SHORT
                                                 }
            } ) ;
            lV7cAsignaturaNombre = StringUtil.PadR( StringUtil.RTrim( AV7cAsignaturaNombre), 20, "%");
            /* Using cursor H00102 */
            pr_default.execute(0, new Object[] {AV6cAsignaturaId, lV7cAsignaturaNombre, AV10cAsignaturaSemestre, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_44_idx = 1;
            sGXsfl_44_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_44_idx), 4, 0)), 4, "0");
            SubsflControlProps_442( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subGrid1_Recordsperpage( ) ) ) ) )
            {
               A21AsignaturaSemestre = H00102_A21AsignaturaSemestre[0];
               A11AsignaturaNombre = H00102_A11AsignaturaNombre[0];
               A10AsignaturaId = H00102_A10AsignaturaId[0];
               /* Execute user event: Load */
               E16102 ();
      ...
      protected int subGrid1_Recordcount( )
      {
         ...
         lV7cAsignaturaNombre = StringUtil.PadR( StringUtil.RTrim( AV7cAsignaturaNombre), 20, "%");
         /* Using cursor H00103 */
         pr_default.execute(1, new Object[] {AV6cAsignaturaId, lV7cAsignaturaNombre, AV10cAsignaturaSemestre});
      ...
      protected void STRUP100( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            if ( context.localUtil.VCDate( cgiGet( edtavCasignaturasemestre_Internalname), 1) == 0 )
            {
               ...
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "GX_FocusControl", GX_FocusControl);
               wbErr = true;
               AV10cAsignaturaSemestre = DateTime.MinValue;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10cAsignaturaSemestre", context.localUtil.Format(AV10cAsignaturaSemestre, "99/99/99"));
            }
            else
            {
               AV10cAsignaturaSemestre = context.localUtil.CToD( cgiGet( edtavCasignaturasemestre_Internalname), 1);
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV10cAsignaturaSemestre", context.localUtil.Format(AV10cAsignaturaSemestre, "99/99/99"));
            }
            /* Read saved values. */
            ...
            if ( context.localUtil.CToD( cgiGet( "GXH_vCASIGNATURASEMESTRE"), 1) != AV10cAsignaturaSemestre )
            {
               GRID1_nFirstRecordOnPage = 0;
            }
         }
      ...
      {
         /* Enter Routine */
         AV8pAsignaturaId = A10AsignaturaId;
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8pAsignaturaId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV8pAsignaturaId), 4, 0)));
         context.setWebReturnParms(new Object[] {(short)AV8pAsignaturaId});
         context.setWebReturnParmsMetadata(new Object[] {"AV8pAsignaturaId"});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2020101710485075", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0030.js", "?2020101710485075", false, true);
      ...
      protected void sendrow_442( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_44_idx <= subGrid1_Recordsperpage( ) * 1 ) )
         {
            ...
            edtAsignaturaNombre_Link = "javascript:gx.popup.gxReturn(["+"'"+GXUtil.EncodeJSConstant( StringUtil.LTrim( StringUtil.NToC( (decimal)(A10AsignaturaId), 4, 0, ".", "")))+"'"+"]);";
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, edtAsignaturaNombre_Internalname, "Link", edtAsignaturaNombre_Link, !bGXsfl_44_Refreshing);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cAsignaturaId',fld:'vCASIGNATURAID',pic:'ZZZ9'},{av:'AV7cAsignaturaNombre',fld:'vCASIGNATURANOMBRE',pic:''},{av:'AV10cAsignaturaSemestre',fld:'vCASIGNATURASEMESTRE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E14101',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLASIGNATURAIDFILTER.CLICK","{handler:'E11101',iparms:[{av:'divAsignaturaidfiltercontainer_Class',ctrl:'ASIGNATURAIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLASIGNATURANOMBREFILTER.CLICK","{handler:'E12101',iparms:[{av:'divAsignaturanombrefiltercontainer_Class',ctrl:'ASIGNATURANOMBREFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLASIGNATURASEMESTREFILTER.CLICK","{handler:'E13101',iparms:[{av:'divAsignaturasemestrefiltercontainer_Class',ctrl:'ASIGNATURASEMESTREFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E17102',iparms:[{av:'A10AsignaturaId',fld:'ASIGNATURAID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8pAsignaturaId',fld:'vPASIGNATURAID',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cAsignaturaId',fld:'vCASIGNATURAID',pic:'ZZZ9'},{av:'AV7cAsignaturaNombre',fld:'vCASIGNATURANOMBRE',pic:''},{av:'AV10cAsignaturaSemestre',fld:'vCASIGNATURASEMESTRE',pic:''}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cAsignaturaId',fld:'vCASIGNATURAID',pic:'ZZZ9'},{av:'AV7cAsignaturaNombre',fld:'vCASIGNATURANOMBRE',pic:''},{av:'AV10cAsignaturaSemestre',fld:'vCASIGNATURASEMESTRE',pic:''}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cAsignaturaId',fld:'vCASIGNATURAID',pic:'ZZZ9'},{av:'AV7cAsignaturaNombre',fld:'vCASIGNATURANOMBRE',pic:''},{av:'AV10cAsignaturaSemestre',fld:'vCASIGNATURASEMESTRE',pic:''}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cAsignaturaId',fld:'vCASIGNATURAID',pic:'ZZZ9'},{av:'AV7cAsignaturaNombre',fld:'vCASIGNATURANOMBRE',pic:''},{av:'AV10cAsignaturaSemestre',fld:'vCASIGNATURASEMESTRE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         H00102_A21AsignaturaSemestre = new DateTime[] {DateTime.MinValue} ;
         H00102_A11AsignaturaNombre = new String[] {""} ;
         H00102_A10AsignaturaId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0030__default(),
            new Object[][] {
                new Object[] {
               H00102_A21AsignaturaSemestre, H00102_A11AsignaturaNombre, H00102_A10AsignaturaId
               }
               , new Object[] {
      ...
      private DateTime AV10cAsignaturaSemestre ;
      ...
      private DateTime[] H00102_A21AsignaturaSemestre ;
      private String[] H00102_A11AsignaturaNombre ;
      private short[] H00102_A10AsignaturaId ;
   ...
   public class gx0030__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             short AV6cAsignaturaId )
      {
         ...
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV7cAsignaturaNombre)) )
         {
         ...
         if ( ! (DateTime.MinValue==AV10cAsignaturaSemestre) )
         {
            sWhereString = sWhereString + " and ([AsignaturaSemestre] >= @AV10cAsignaturaSemestre)";
         }
         else
         {
            GXv_int1[2] = 1;
         }
         sOrderString = sOrderString + " ORDER BY [AsignaturaId]";
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00102(context, (String)dynConstraints[0] , (DateTime)dynConstraints[1] , (String)dynConstraints[2] , (DateTime)dynConstraints[3] , (short)dynConstraints[4] );
               case 1 :
                     return conditional_H00103(context, (String)dynConstraints[0] , (DateTime)dynConstraints[1] , (String)dynConstraints[2] , (DateTime)dynConstraints[3] , (short)dynConstraints[4] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV10cAsignaturaSemestre",SqlDbType.DateTime,8,0} ,

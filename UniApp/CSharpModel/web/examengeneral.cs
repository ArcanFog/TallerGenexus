/*
       ...
       Generated on: 10/17/2020 11:15:44.70
...
namespace GeneXus.Programs {
   public class examengeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public examengeneral( IGxContext context )
      {
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  setjustcreated();
                  componentprepare(new Object[] {(String)sCompPrefix,(String)sSFPrefix,(short)A17ExamenId});
                  componentstart();
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Examen General") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2020101711154474", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.skipLines(1);
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("examengeneral.aspx") + "?" + UrlEncode("" +A17ExamenId)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOA17ExamenId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOA17ExamenId), 4, 0, ".", "")));
      }
      ...
      protected void RenderHtmlCloseForm0Y2( )
      {
         ...
         {
            context.AddJavascriptSource("examengeneral.js", "?2020101711154476", false, true);
         }
      ...
      protected void WB0Y0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "examengeneral.aspx");
            }
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtnupdate_Internalname, "", "Update", bttBtnupdate_Jsonclick, 7, "Update", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e110y1_client"+"'", TempTags, "", 2, "HLP_ExamenGeneral.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtndelete_Internalname, "", "Delete", bttBtndelete_Jsonclick, 7, "Delete", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+"e120y1_client"+"'", TempTags, "", 2, "HLP_ExamenGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtExamenId_Internalname, "Id", "col-sm-3 ReadonlyAttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtExamenId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A17ExamenId), 4, 0, ".", "")), ((edtExamenId_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A17ExamenId), "ZZZ9")) : context.localUtil.Format( (decimal)(A17ExamenId), "ZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtExamenId_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtExamenId_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_ExamenGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_single_line_edit( context, edtExamenFecha_Internalname, context.localUtil.Format(A26ExamenFecha, "99/99/99"), context.localUtil.Format( A26ExamenFecha, "99/99/99"), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtExamenFecha_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtExamenFecha_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_ExamenGeneral.htm");
            GxWebStd.gx_bitmap( context, edtExamenFecha_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtExamenFecha_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_ExamenGeneral.htm");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtExamenCarrAsigAsignaturaId_Internalname, "Asignatura Id", "col-sm-3 ReadonlyAttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtExamenCarrAsigAsignaturaId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A24ExamenCarrAsigAsignaturaId), 4, 0, ".", "")), ((edtExamenCarrAsigAsignaturaId_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A24ExamenCarrAsigAsignaturaId), "ZZZ9")) : context.localUtil.Format( (decimal)(A24ExamenCarrAsigAsignaturaId), "ZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtExamenCarrAsigAsignaturaId_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtExamenCarrAsigAsignaturaId_Enabled, 0, "number", "1", 4, "chr", 1, "row", 4, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_ExamenGeneral.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Attribute/Variable Label */
            GxWebStd.gx_label_element( context, edtExamenCarrAsigAsignaturaNombre_Internalname, "Asignatura Nombre", "col-sm-3 ReadonlyAttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
      ...
      protected void START0Y2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Examen General", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF0Y2( )
      {
         ...
         {
            /* Using cursor H000Y2 */
            pr_default.execute(0, new Object[] {A17ExamenId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A25ExamenCarrAsigAsignaturaNombre = H000Y2_A25ExamenCarrAsigAsignaturaNombre[0];
               ...
               A24ExamenCarrAsigAsignaturaId = H000Y2_A24ExamenCarrAsigAsignaturaId[0];
               ...
               A23ExamenCarrAsigCarreraNombre = H000Y2_A23ExamenCarrAsigCarreraNombre[0];
               ...
               A22ExamenCarrAsigCarreraId = H000Y2_A22ExamenCarrAsigCarreraId[0];
               ...
               A26ExamenFecha = H000Y2_A26ExamenFecha[0];
      ...
      protected void STRUP0Y0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A25ExamenCarrAsigAsignaturaNombre", A25ExamenCarrAsigAsignaturaNombre);
            /* Read saved values. */
            wcpOA17ExamenId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA17ExamenId"), ".", ","));
      ...
      protected void S112( )
      {
         ...
         AV7TrnContext.gxTpr_Transactionname = "Examen";
         AV8TrnContextAtt = new SdtTransactionContext_Attribute(context);
         AV8TrnContextAtt.gxTpr_Attributename = "ExamenId";
         AV8TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6ExamenId), 4, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         A17ExamenId = Convert.ToInt16(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A17ExamenId", StringUtil.LTrim( StringUtil.Str( (decimal)(A17ExamenId), 4, 0)));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlA17ExamenId = (String)((String)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "examengeneral", GetJustCreated( ));
         ...
         {
            A17ExamenId = Convert.ToInt16(getParm(obj,2));
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A17ExamenId", StringUtil.LTrim( StringUtil.Str( (decimal)(A17ExamenId), 4, 0)));
         }
         wcpOA17ExamenId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOA17ExamenId"), ".", ","));
         if ( ! GetJustCreated( ) && ( ( A17ExamenId != wcpOA17ExamenId ) ) )
         {
            setjustcreated();
         }
         wcpOA17ExamenId = A17ExamenId;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlA17ExamenId = cgiGet( sPrefix+"A17ExamenId_CTRL");
         if ( StringUtil.Len( sCtrlA17ExamenId) > 0 )
         {
            A17ExamenId = (short)(context.localUtil.CToN( cgiGet( sCtrlA17ExamenId), ".", ","));
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A17ExamenId", StringUtil.LTrim( StringUtil.Str( (decimal)(A17ExamenId), 4, 0)));
         }
         else
         {
            A17ExamenId = (short)(context.localUtil.CToN( cgiGet( sPrefix+"A17ExamenId_PARM"), ".", ","));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"A17ExamenId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(A17ExamenId), 4, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlA17ExamenId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"A17ExamenId_CTRL", StringUtil.RTrim( sCtrlA17ExamenId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2020101711154535", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("examengeneral.js", "?2020101711154536", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'DOUPDATE'","{handler:'E110Y1',iparms:[{av:'A17ExamenId',fld:'EXAMENID',pic:'ZZZ9'}]");
         setEventMetadata("'DOUPDATE'",",oparms:[]}");
         setEventMetadata("'DODELETE'","{handler:'E120Y1',iparms:[{av:'A17ExamenId',fld:'EXAMENID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H000Y2_A17ExamenId = new short[1] ;
         H000Y2_A25ExamenCarrAsigAsignaturaNombre = new String[] {""} ;
         H000Y2_A24ExamenCarrAsigAsignaturaId = new short[1] ;
         H000Y2_A23ExamenCarrAsigCarreraNombre = new String[] {""} ;
         H000Y2_A22ExamenCarrAsigCarreraId = new short[1] ;
         H000Y2_A26ExamenFecha = new DateTime[] {DateTime.MinValue} ;
         AV7TrnContext = new SdtTransactionContext(context);
         ...
         sCtrlA17ExamenId = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.examengeneral__default(),
            new Object[][] {
                new Object[] {
               H000Y2_A17ExamenId, H000Y2_A25ExamenCarrAsigAsignaturaNombre, H000Y2_A24ExamenCarrAsigAsignaturaId, H000Y2_A23ExamenCarrAsigCarreraNombre, H000Y2_A22ExamenCarrAsigCarreraId, H000Y2_A26ExamenFecha
               }
            }
         );
         AV13Pgmname = "ExamenGeneral";
      ...
      private String sCtrlA17ExamenId ;
      ...
      private short[] H000Y2_A17ExamenId ;
      private String[] H000Y2_A25ExamenCarrAsigAsignaturaNombre ;
      private short[] H000Y2_A24ExamenCarrAsigAsignaturaId ;
      private String[] H000Y2_A23ExamenCarrAsigCarreraNombre ;
      private short[] H000Y2_A22ExamenCarrAsigCarreraId ;
      private DateTime[] H000Y2_A26ExamenFecha ;
   ...
   public class examengeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000Y2", "SELECT T1.[ExamenId], T3.[AsignaturaNombre] AS ExamenCarrAsigAsignaturaNombre, T1.[ExamenCarrAsigAsignaturaId] AS ExamenCarrAsigAsignaturaId, T2.[CarreraNombre] AS ExamenCarrAsigCarreraNombre, T1.[ExamenCarrAsigCarreraId] AS ExamenCarrAsigCarreraId, T1.[ExamenFecha] FROM (([Examen] T1 WITH (NOLOCK) INNER JOIN [Carrera] T2 WITH (NOLOCK) ON T2.[CarreraId] = T1.[ExamenCarrAsigCarreraId]) INNER JOIN [CarreraAsignatura] T3 WITH (NOLOCK) ON T3.[CarreraId] = T1.[ExamenCarrAsigCarreraId] AND T3.[AsignaturaId] = T1.[ExamenCarrAsigAsignaturaId]) WHERE T1.[ExamenId] = @ExamenId ORDER BY T1.[ExamenId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000Y2,1,0,true,true )
          };
       }
    }

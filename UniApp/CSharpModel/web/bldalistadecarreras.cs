...
using System.IO;
public class bldalistadecarreras : GxBaseBuilder
{
   string cs_path = "." ;
   public bldalistadecarreras( ) : base()
   {
   }
   ...
   {
      bldalistadecarreras x = new bldalistadecarreras() ;
      x.SetMainSourceFile( "alistadecarreras.cs");

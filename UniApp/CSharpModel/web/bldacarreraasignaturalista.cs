...
using System.IO;
public class bldacarreraasignaturalista : GxBaseBuilder
{
   string cs_path = "." ;
   public bldacarreraasignaturalista( ) : base()
   {
   }
   ...
   {
      bldacarreraasignaturalista x = new bldacarreraasignaturalista() ;
      x.SetMainSourceFile( "acarreraasignaturalista.cs");

/*
			...
			Description: Attributes
				 Author: Nemo 🐠 for C# version 16.0.1.129648
...
namespace GeneXus.Programs
{
	...
	[XmlType(TypeName="TransactionContext.Attribute" , Namespace="UniApp" )]
	[Serializable]
	...
	[DataContract(Name=@"TransactionContext.Attribute", Namespace="UniApp")]
